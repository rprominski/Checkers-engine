...
std::string MoveFinder::getNewPositionForMen(std::string position, int xDirection, int yDirection, char color,int field)
{
    int x,y;
...
void MoveFinder::checkDirectionForCapture(std::string position, int field, int xDirection, int yDirection, char color, std::vector<int> kingMoves)
{
    bool capture=0;
